        ...
        <div class="container" style="margin-top: 50px">
          <div class="row">
            ...
            <div class="col-md-6">
              ...
              <p>
                category: <?php echo $row["type_name"];?>
              </p>
            </h3>
              <?php echo $row["p_detail"];?>
              <p ><?php echo $row["p_price"];?> VND</p>
                 <p> 
                   <a href="cart.php?p_id=$row[p_id]&act=add" class="btn btn-primary">Add to cart</a>
            </div>
